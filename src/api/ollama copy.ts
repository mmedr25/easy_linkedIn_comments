...
const generatePrePrompts = (prePrompts: PrePrompts) => {
...
const generatePrompt = (prompt: Prompt, prePrompts: PrePrompts) => {
    const prePromptsString = generatePrePrompts(prePrompts);
